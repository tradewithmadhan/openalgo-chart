...
// Scale Mode Icons
const SamePercentIcon: React.FC = () => (
...
const NewPriceScaleIcon: React.FC = () => (
    <svg viewBox="0 0 28 28" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5">
        <rect x="4" y="4" width="20" height="16" rx="2" />
...
type ScaleMode = 'samePercent' | 'newPriceScale' | 'newPane';
...
export interface CompareOptionsDialogProps {
    visible: boolean;
    symbol: string;
    exchange: string;
    symbolColor?: string;
    onConfirm: (mode: ScaleMode) => void;
    onCancel: () => void;
}

const CompareOptionsDialog: React.FC<CompareOptionsDialogProps> = ({
    visible,
    symbol,
    exchange,
    symbolColor,
    ...
    const [selectedMode, setSelectedMode] = useState<ScaleMode>('samePercent');
