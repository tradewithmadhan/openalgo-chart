...
export class MouseHandlers {
	...
	private _mouseDown: Delegate<MousePosition | null> = new Delegate();
	private _mouseUp: Delegate<MousePosition | null> = new Delegate();
	...
	public mouseDown(): ISubscription<MousePosition | null> {
		return this._mouseDown;
	}

	public mouseUp(): ISubscription<MousePosition | null> {
	...
	_handleMouseDown(event: MouseEvent) {
		this._mouseDown.fire(this._determineMousePosition(event));
	}
	_handleMouseUp(event: MouseEvent) {
		this._mouseUp.fire(this._determineMousePosition(event));
	}
